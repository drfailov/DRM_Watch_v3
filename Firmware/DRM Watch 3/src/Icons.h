...
const unsigned char ic16_watchface [] = {
0x00, 0x00, 0x00, 0x00, 0x0C, 0x30, 0x7F, 0xFE, 0x40, 0x02, 0x4C, 0x02, 0x46, 0x62, 0x43, 0xC2,
0x41, 0x82, 0x40, 0x02, 0x40, 0x02, 0x7F, 0xFE, 0x7F, 0xFE, 0x0C, 0x30, 0x00, 0x00, 0x00, 0x00
}; void draw_ic16_watchface(int x, int y, bool color){lcd()->setColorIndex(color);  lcd()->drawBitmap(x, y, 2, 16, ic16_watchface);}

const unsigned char ic16_hashtag [] = {
0x07, 0x1C, 0x06, 0x18, 0x06, 0x18, 0x0E, 0x38, 0x3F, 0xFE, 0x3F, 0xFE, 0x0E, 0x38, 0x0C, 0x30,
0x0C, 0x30, 0x1C, 0x70, 0x7F, 0xFC, 0x7F, 0xFC, 0x1C, 0x70, 0x18, 0x60, 0x18, 0x60, 0x38, 0xE0
};  void draw_ic16_hashtag(int x, int y, bool color){lcd()->setColorIndex(color);  lcd()->drawBitmap(x, y, 2, 16, ic16_hashtag);}

//----------------------//----------------------//----------------------//----------------------//----------------------//----------------------//----------------------

const unsigned char ic24_terminal [] = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3F, 0xFF, 0xFC, 0x7F, 0xFF, 0xFE, 0x7F, 0xFF, 0xFE, 0x7F,
0xFF, 0xFE, 0x7D, 0xFF, 0xFE, 0x78, 0xFF, 0xFE, 0x78, 0x7F, 0xFE, 0x7C, 0x3F, 0xFE, 0x7E, 0x1F,
0xFE, 0x7F, 0x0F, 0xFE, 0x7F, 0x0F, 0xFE, 0x7E, 0x1F, 0xFE, 0x7C, 0x3F, 0xFE, 0x78, 0x70, 0x1E,
0x78, 0xF0, 0x1E, 0x7D, 0xF0, 0x1E, 0x7F, 0xFF, 0xFE, 0x7F, 0xFF, 0xFE, 0x7F, 0xFF, 0xFE, 0x3F,
0xFF, 0xFC, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
}; void draw_ic24_terminal(int x, int y, bool color){lcd()->setColorIndex(color);  lcd()->drawBitmap(x, y, 3, 24, ic24_terminal);}
...
const unsigned char ic24_pixels [] = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1F, 0xE0, 0x00, 0x1F, 0xE0, 0x00, 0x1F, 0xE0, 0x00, 0x1F,
0xE0, 0x38, 0x1F, 0xE0, 0x38, 0x1F, 0xE0, 0x38, 0x1F, 0xE0, 0x00, 0x1F, 0xE0, 0x00, 0x00, 0x1C,
0x00, 0x00, 0x1C, 0x00, 0x00, 0x1C, 0x00, 0x60, 0x00, 0x00, 0x60, 0x00, 0x1F, 0x00, 0x00, 0x1F,
0x07, 0x00, 0x1F, 0x07, 0x00, 0x1F, 0x07, 0xF0, 0x1F, 0x00, 0xF1, 0x80, 0x00, 0xF1, 0x80, 0x00,
0xF0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
};  void draw_ic24_pixels(int x, int y, bool color){lcd()->setColorIndex(color);  lcd()->drawBitmap(x, y, 3, 24, ic24_pixels);}


const unsigned char ic24_animation [] = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x0F, 0x1C, 0x70, 0x3F, 0xCF, 0x3C, 0x7F, 0xE7, 0x9E, 0x7F, 0xE7, 0x9E, 0xFF, 0xF7,
0xCF, 0xFF, 0xF3, 0xCF, 0xFF, 0xF3, 0xCF, 0xFF, 0xF7, 0xCF, 0x7F, 0xE7, 0x9E, 0x7F, 0xE7, 0x9E,
0x3F, 0xCF, 0x3C, 0x0F, 0x1C, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
}; void draw_ic24_animation(int x, int y, bool color){lcd()->setColorIndex(color);  lcd()->drawBitmap(x, y, 3, 24, ic24_animation);}


const unsigned char ic24_shortcut [] = {
0x00, 0x03, 0xFF, 0x00, 0x07, 0xFF, 0x00, 0x03, 0xFF, 0x3F, 0xE0, 0x3F, 0x7F, 0xF0, 0x7F, 0xFF,
0xE0, 0xFF, 0xF0, 0x01, 0xF7, 0xE0, 0x03, 0xE7, 0xE0, 0x07, 0xC7, 0xE0, 0x0F, 0x87, 0xE0, 0x1F,
0x02, 0xE0, 0x3E, 0x00, 0xE0, 0x7C, 0x10, 0xE0, 0xF8, 0x38, 0xE0, 0xF0, 0x38, 0xE0, 0xE0, 0x38,
0xE0, 0x00, 0x38, 0xE0, 0x00, 0x38, 0xE0, 0x00, 0x38, 0xE0, 0x00, 0x38, 0xF0, 0x00, 0x78, 0xFF,
0xFF, 0xF8, 0x7F, 0xFF, 0xF0, 0x3F, 0xFF, 0xE0, 
}; void draw_ic24_shortcut(int x, int y, bool color){lcd()->setColorIndex(color);  lcd()->drawBitmap(x, y, 3, 24, ic24_shortcut);}


const unsigned char ic24_ant2 [] = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0xC0, 0x00, 0x03,
0xC0, 0x00, 0x0C, 0x30, 0x00, 0x0C, 0x30, 0x00, 0x3F, 0x00, 0xC0, 0x3F, 0x00, 0xC0, 0x3C, 0x0F,
0x30, 0x3C, 0x0F, 0x30, 0x0F, 0xC0, 0x30, 0x0F, 0xC0, 0x30, 0x00, 0x30, 0xC0, 0x00, 0x30, 0xC0,
0x00, 0x0F, 0x00, 0x00, 0x0F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
}; void draw_ic24_ant2(int x, int y, bool color){lcd()->setColorIndex(color);  lcd()->drawBitmap(x, y, 3, 24, ic24_ant2);}


const unsigned char ic24_backlight [] = {
0x00, 0x3E, 0x00, 0x01, 0xFE, 0x00, 0x07, 0xFE, 0x3F, 0x0F, 0xFE, 0x3F, 0x1F, 0xFF, 0x00, 0x3F,
0xFF, 0x00, 0x3F, 0xFF, 0x00, 0x7F, 0xFF, 0x00, 0x7F, 0xFF, 0x3F, 0xFF, 0xFF, 0x3F, 0xFF, 0xFF,
0x00, 0xFF, 0xFF, 0x00, 0xFF, 0xFF, 0x00, 0xFF, 0xFF, 0x00, 0xFF, 0xFF, 0x3F, 0x7F, 0xFF, 0x3F,
0x7F, 0xFF, 0x00, 0x3F, 0xFF, 0x00, 0x3F, 0xFF, 0x00, 0x1F, 0xFF, 0x00, 0x0F, 0xFE, 0x3F, 0x07,
0xFE, 0x3F, 0x01, 0xFE, 0x00, 0x00, 0x3E, 0x00, 
}; void draw_ic24_backlight(int x, int y, bool color){lcd()->setColorIndex(color);  lcd()->drawBitmap(x, y, 3, 24, ic24_backlight);}


const unsigned char ic24_flashlight2 [] = {
0x00, 0x18, 0x00, 0x04, 0x18, 0x20, 0x0E, 0x18, 0x70, 0x07, 0x18, 0xE0, 0x03, 0x18, 0xC0, 0x03,
0x00, 0xC0, 0x00, 0x00, 0x00, 0x03, 0xFF, 0xC0, 0x07, 0xFF, 0xE0, 0x07, 0xFF, 0xE0, 0x07, 0xFF,
...
}; void draw_ic24_flashlight2(int x, int y, bool color){lcd()->setColorIndex(color);  lcd()->drawBitmap(x, y, 3, 24, ic24_flashlight2);}


const unsigned char ic24_fire [] = {
0x00, 0x02, 0x00, 0x00, 0x0E, 0x00, 0x00, 0x1E, 0x00, 0x00, 0x3E, 0x00, 0x00, 0x7E, 0x00, 0x00,
0xFF, 0x00, 0x00, 0xFF, 0x00, 0x01, 0xFF, 0x80, 0x01, 0xFF, 0xC0, 0x0B, 0xFF, 0xE0, 0x0F, 0xFF,
0xE0, 0x1F, 0xFF, 0xF0, 0x1F, 0xFF, 0xF0, 0x1F, 0xFF, 0xF8, 0x1F, 0xFF, 0xF8, 0x3F, 0xE7, 0xF8,
0x3F, 0xC7, 0xF8, 0x1F, 0xC3, 0xF8, 0x1F, 0x81, 0xF8, 0x1F, 0x01, 0xF0, 0x0F, 0x00, 0xF0, 0x07,
0x00, 0xE0, 0x03, 0x81, 0xC0, 0x00, 0x80, 0x00, 
}; void draw_ic24_fire(int x, int y, bool color){lcd()->setColorIndex(color);  lcd()->drawBitmap(x, y, 3, 24, ic24_fire);}


const unsigned char ic24_bubbles [] = {
0x01, 0xF0, 0x00, 0x07, 0xF8, 0x00, 0x1F, 0xFE, 0x00, 0x1F, 0xFE, 0x00, 0x3D, 0xFF, 0x00, 0x39,
0xFF, 0x00, 0x3B, 0xFF, 0x00, 0x3B, 0xFF, 0x80, 0x3F, 0xFF, 0x00, 0x3D, 0xFF, 0x00, 0x3D, 0xFF,
0x00, 0x1F, 0xFE, 0x3C, 0x0F, 0xFE, 0x7C, 0x07, 0xF8, 0x7E, 0x03, 0xF0, 0x3C, 0x00, 0x00, 0x18,
0x00, 0x0F, 0x00, 0x00, 0x1F, 0x80, 0x00, 0x3F, 0xC0, 0x00, 0x3F, 0xC0, 0x00, 0x3F, 0xC0, 0x00,
0x3F, 0xC0, 0x00, 0x1F, 0x80, 0x00, 0x0F, 0x00, 
}; void draw_ic24_bubbles(int x, int y, bool color){lcd()->setColorIndex(color);  lcd()->drawBitmap(x, y, 3, 24, ic24_bubbles);}


const unsigned char ic24_frequency [] = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xC0, 0x00, 0x01, 0xC0, 0x00, 0x01,
0xC0, 0x00, 0x03, 0xC0, 0x00, 0x03, 0xE1, 0x80, 0x03, 0xE3, 0xC0, 0x07, 0x63, 0xC0, 0x06, 0x63,
0xE0, 0xFE, 0x73, 0x7F, 0xFE, 0x77, 0x7F, 0x00, 0x37, 0x00, 0x00, 0x3E, 0x00, 0x00, 0x3E, 0x00,
0x00, 0x3E, 0x00, 0x00, 0x3C, 0x00, 0x00, 0x1C, 0x00, 0x00, 0x1C, 0x00, 0x00, 0x18, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
}; void draw_ic24_frequency(int x, int y, bool color){lcd()->setColorIndex(color);  lcd()->drawBitmap(x, y, 3, 24, ic24_frequency);}


const unsigned char ic24_file [] = {
0x0F, 0xFC, 0x00, 0x1F, 0xFD, 0x80, 0x1F, 0xFD, 0xC0, 0x1F, 0xFD, 0xE0, 0x1F, 0xFD, 0xF0, 0x1F,
0xFD, 0xF0, 0x1F, 0xFC, 0x00, 0x1F, 0xFF, 0xF8, 0x1F, 0xFF, 0xF8, 0x1C, 0x00, 0x38, 0x1C, 0x00,
0x38, 0x1F, 0xFF, 0xF8, 0x1F, 0xFF, 0xF8, 0x1C, 0x00, 0x38, 0x1C, 0x00, 0x38, 0x1F, 0xFF, 0xF8,
0x1F, 0xFF, 0xF8, 0x1C, 0x07, 0xF8, 0x1C, 0x07, 0xF8, 0x1F, 0xFF, 0xF8, 0x1F, 0xFF, 0xF8, 0x1F,
0xFF, 0xF8, 0x1F, 0xFF, 0xF8, 0x0F, 0xFF, 0xF0, 
}; void draw_ic24_file(int x, int y, bool color){lcd()->setColorIndex(color);  lcd()->drawBitmap(x, y, 3, 24, ic24_file);}


const unsigned char ic24_memory [] = {
0x03, 0xFF, 0xF8, 0x07, 0xFF, 0xFC, 0x06, 0x31, 0x8C, 0x06, 0x31, 0x8C, 0x06, 0x31, 0x8C, 0x06,
0x31, 0x8C, 0x06, 0x31, 0x8C, 0x07, 0xFF, 0xFC, 0x0F, 0xFF, 0xFC, 0x1F, 0xFF, 0xFC, 0x3F, 0xFF,
...
}; void draw_ic24_memory(int x, int y, bool color){lcd()->setColorIndex(color);  lcd()->drawBitmap(x, y, 3, 24, ic24_memory);}


const unsigned char ic24_partitions [] = {
0x00, 0x07, 0x00, 0x00, 0x07, 0xC0, 0x01, 0xE7, 0xF0, 0x07, 0xE7, 0xF8, 0x0F, 0xE7, 0xFC, 0x1F,
0xE7, 0xFC, 0x3F, 0xE7, 0xFE, 0x7F, 0xE7, 0xFE, 0x7F, 0xE7, 0xFF, 0xFF, 0xE7, 0xFF, 0xFF, 0xE7,
0xFF, 0xFF, 0xE0, 0x00, 0xFF, 0xE0, 0x00, 0xFF, 0xFF, 0xFC, 0xFF, 0xFF, 0xFC, 0xFF, 0xFF, 0xFC,
0x7F, 0xFF, 0xFC, 0x7F, 0xFF, 0xF8, 0x3F, 0xFF, 0xF8, 0x3F, 0xFF, 0xF0, 0x1F, 0xFF, 0xE0, 0x0F,
0xFF, 0xC0, 0x03, 0xFF, 0x80, 0x00, 0xFE, 0x00, 
}; void draw_ic24_partitions(int x, int y, bool color){lcd()->setColorIndex(color);  lcd()->drawBitmap(x, y, 3, 24, ic24_partitions);}


const unsigned char ic24_folder [] = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7F, 0xE0, 0x00, 0xFF, 0xF0, 0x00, 0xFF, 0xF8, 0x00, 0xFF,
0xFF, 0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x7F, 0xFF, 0xFE, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
}; void draw_ic24_folder(int x, int y, bool color){lcd()->setColorIndex(color);  lcd()->drawBitmap(x, y, 3, 24, ic24_folder);}


const unsigned char ic24_clean2 [] = {
0x10, 0x00, 0x40, 0x38, 0x00, 0xE0, 0x7C, 0x00, 0xE0, 0xFE, 0x01, 0xF0, 0x7C, 0x07, 0xFC, 0x38,
0x0F, 0xFE, 0x10, 0x07, 0xFC, 0x00, 0x01, 0xF0, 0x00, 0x00, 0xE0, 0x01, 0x00, 0xE0, 0x03, 0x80,
0x40, 0x03, 0x80, 0x00, 0x07, 0xC0, 0x00, 0x0F, 0xE0, 0x00, 0x1F, 0xF0, 0x00, 0x7F, 0xFC, 0x00,
0xFF, 0xFE, 0x00, 0x7F, 0xFC, 0x10, 0x1F, 0xF0, 0x10, 0x0F, 0xE0, 0x38, 0x07, 0xC0, 0xFE, 0x03,
0x80, 0x38, 0x03, 0x80, 0x10, 0x01, 0x00, 0x10, 
}; void draw_ic24_clean2(int x, int y, bool color){lcd()->setColorIndex(color);  lcd()->drawBitmap(x, y, 3, 24, ic24_clean2);}


const unsigned char ic24_clean [] = {
0x00, 0x00, 0x18, 0x00, 0x00, 0x3C, 0x00, 0x00, 0x3E, 0x00, 0x00, 0x7E, 0x00, 0x00, 0x7E, 0x00,
0x00, 0xFC, 0x00, 0x01, 0xFC, 0x08, 0x03, 0xFC, 0x1C, 0x0F, 0xF8, 0x08, 0x1F, 0xF8, 0x40, 0x1F,
0xF8, 0xE0, 0xC7, 0xF0, 0x41, 0xF3, 0xF0, 0x07, 0xF8, 0xF0, 0x1F, 0xFE, 0x30, 0x3F, 0xFF, 0x80,
0x3F, 0xFF, 0xE0, 0x1E, 0xFF, 0xE0, 0x0C, 0xF7, 0xC0, 0x01, 0xF7, 0xC0, 0x01, 0xE7, 0x80, 0x00,
0xCF, 0x00, 0x00, 0x1F, 0x00, 0x00, 0x0E, 0x00, 
}; void draw_ic24_clean(int x, int y, bool color){lcd()->setColorIndex(color);  lcd()->drawBitmap(x, y, 3, 24, ic24_clean);}


const unsigned char ic24_bad_file [] = {
0x03, 0x00, 0x00, 0x3F, 0x01, 0xD0, 0xFF, 0xC1, 0xD8, 0xFF, 0xC0, 0xDC, 0xFF, 0x80, 0xDE, 0x7F,
0x81, 0xDF, 0x7F, 0x83, 0xE0, 0x7F, 0xC1, 0xFF, 0x7F, 0xE1, 0xFF, 0x3F, 0xF0, 0xFF, 0x3F, 0xF0,
0xFF, 0x3F, 0xE0, 0xFF, 0x3F, 0xE0, 0xFF, 0x1F, 0xE1, 0xFF, 0x1F, 0xE1, 0xFF, 0x1F, 0xFB, 0xFF,
0x1F, 0xF9, 0xFF, 0x0F, 0xF8, 0xFF, 0x0F, 0xF8, 0xFF, 0x0F, 0xF0, 0xFF, 0x07, 0xF1, 0xFF, 0x07,
0xE1, 0xFF, 0x03, 0x01, 0xFE, 0x00, 0x00, 0x00, 
}; void draw_ic24_bad_file(int x, int y, bool color){lcd()->setColorIndex(color);  lcd()->drawBitmap(x, y, 3, 24, ic24_bad_file);}


const unsigned char ic24_usb [] = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x0E, 0x00, 0x00, 0x1F, 0x00, 0x00, 0xFF, 0x00, 0x01, 0xFF, 0x00, 0x01, 0x8E, 0x10, 0x73, 0x80,
0x1C, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x70, 0x70, 0x1C, 0x00, 0x30, 0x10, 0x00, 0x3B, 0xC0,
0x00, 0x1F, 0xC0, 0x00, 0x0F, 0xC0, 0x00, 0x03, 0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
}; void draw_ic24_usb(int x, int y, bool color){lcd()->setColorIndex(color);  lcd()->drawBitmap(x, y, 3, 24, ic24_usb);}

const unsigned char ic24_image [] = {
0x1F, 0xFF, 0xF8, 0x3F, 0xFF, 0xFC, 0x7F, 0xFF, 0xFE, 0xF0, 0x00, 0x0F, 0xE0, 0x00, 0x07, 0xE0,
0x01, 0xC7, 0xE0, 0x03, 0xE7, 0xE0, 0x03, 0xE7, 0xE3, 0xC1, 0xE7, 0xE7, 0xE0, 0xC7, 0xFF, 0xF8,
0x07, 0xFF, 0xFC, 0x0F, 0xFF, 0xFE, 0x7F, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x7F,
0xFF, 0xFE, 0x3F, 0xFF, 0xFC, 0x1F, 0xFF, 0xF8, 
}; void draw_ic24_image(int x, int y, bool color){lcd()->setColorIndex(color);  lcd()->drawBitmap(x, y, 3, 24, ic24_image);}

const unsigned char ic24_language [] = {
0x00, 0x7E, 0x00, 0x03, 0xFF, 0xC0, 0x07, 0xFF, 0xE0, 0x0E, 0x66, 0x70, 0x1C, 0xE7, 0x38, 0x38,
0xC3, 0x1C, 0x71, 0xC3, 0x8E, 0x7F, 0xFF, 0xFE, 0x7F, 0xFF, 0xFE, 0xFF, 0xFF, 0xFF, 0xE1, 0x81,
0x87, 0xC1, 0x81, 0x83, 0xC1, 0x81, 0x83, 0xE1, 0x81, 0x87, 0xFF, 0xFF, 0xFF, 0x7F, 0xFF, 0xFE,
0x7F, 0xFF, 0xFE, 0x71, 0xC3, 0x8E, 0x38, 0xC3, 0x1C, 0x1C, 0xE7, 0x38, 0x0E, 0x66, 0x70, 0x07,
0xFF, 0xE0, 0x03, 0xFF, 0xC0, 0x00, 0x7E, 0x00, 
}; void draw_ic24_language(int x, int y, bool color){lcd()->setColorIndex(color);  lcd()->drawBitmap(x, y, 3, 24, ic24_language);}

const unsigned char ic24_roundness [] = {
0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFE, 0xFF, 0xFF, 0xFE, 0xFF, 0xFF, 0xFE, 0x00, 0x00, 0x0E, 0x00,
0x00, 0x0E, 0x00, 0x00, 0x0E, 0xFF, 0xF8, 0x0E, 0xFF, 0xFE, 0x0E, 0xFF, 0xFF, 0x0E, 0x00, 0x0F,
0x0E, 0x00, 0x07, 0x8E, 0x00, 0x03, 0x8E, 0xF8, 0x03, 0x8E, 0xFE, 0x03, 0x8E, 0xFF, 0x03, 0x8E,
0x07, 0x83, 0x8E, 0x03, 0xC3, 0x8E, 0x01, 0xC3, 0x8E, 0x00, 0xE3, 0x8E, 0x00, 0xE3, 0x8E, 0x00,
0xE3, 0x8E, 0x00, 0xE3, 0x8E, 0x00, 0xE3, 0x8E, 
};  void draw_ic24_roundness(int x, int y, bool color){lcd()->setColorIndex(color);  lcd()->drawBitmap(x, y, 3, 24, ic24_roundness);}
...
const unsigned char ic33_qrcodex1 [] = {
, 
}; void draw_ic33_qrcodex1(int x, int y, bool color){lcd()->setColorIndex(color);  lcd()->drawBitmap(x, y, 5, 33, ic33_qrcodex1);}
