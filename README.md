...
## Головне меню
Меню з якого доступні основні розділи меню, такі як програми, налаштування, та інформація про годинник.
Кнопками вгору та вниз - обрати пункт меню. Центральна кнопка активує обраний пункт меню. 

## Головне меню -> Програми
Звідси можна запустити функції які не є налаштуваннями. Будильники, секундоміри, ігри, розваги, тощо.
Кнопками вгору та вниз - обрати пункт меню. Центральна кнопка активує обраний пункт меню. 

## Головне меню -> Програми -> Будильник
...
Кнопками вгору та вниз - обрати пункт меню. Центральна кнопка активує обраний пункт меню. Коли пункт меню активований, кнопки вниз та вгору міняють значення пункту.     <br> 
...
## Головне меню -> Налаштування -> Вміст циферблату
...
- Встановити платформу **Espressif 32**
PlatformIO Home (Відкривається при запуску) -> Platforms -> Emnedded -> в пошук "Espressif 32" -> Install
