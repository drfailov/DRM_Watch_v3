...
## Програми -> Лог UART
Годинник імітує COM порт. Всі дані що надходять на COM порт - виводяться в лог на екрані.
...
# Прошивка
Прошивка написана в **VSCode 1.89.1** з використанням розширення **PlatformIO**, компілювати треба під плату **Lolin S2 Mini**.   <br>
